...
export default function AIFeatureCard({ icon, title, iconColor }: AIFeatureCardProps) {
  ...
  return (
    <div className="bg-surface-container-lowest dark:bg-surface-container shadow-lg rounded-xl p-4 border border-outline-variant/30 w-48 text-center flex flex-col items-center transform transition-transform hover:scale-105 hover:border-primary/50 group">
