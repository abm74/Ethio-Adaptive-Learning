  ...
  return (
    <>
      ...
      <nav className={cn(
        ...
        isNexusCollapsed ? "w-[80px]" : "w-[240px]",
        ...
        <div className={cn(
          ...
          isNexusCollapsed ? "p-4 justify-center" : "p-6"
        )}>
          ...
          {NEXUS_ITEMS.map((item) => {
            ...
            return (
              ...
              >
                ...
                {!isNexusCollapsed && (
                  <span className="text-sm animate-in fade-in slide-in-from-left-1 duration-200">
                    {item.label}
                  </span>
                )}
                {isActive && (
        ...
        <div className={cn(
          ...
          >
            ...
            {!isNexusCollapsed && <span className="text-sm">Settings</span>}
          ...
          >
            ...
            {!isNexusCollapsed && <span className="text-sm font-semibold">Support</span>}
          </Link>
        </div>
      </nav>
    </>
