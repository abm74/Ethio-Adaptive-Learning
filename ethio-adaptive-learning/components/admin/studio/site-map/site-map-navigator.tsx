...
export function SiteMapNavigator({ projects }: { projects: SiteMapProject[] }) {
  ...
  return (
    <div className="flex h-full flex-col overflow-hidden border-r border-outline-variant/30 bg-surface-container-lowest/70">
      <div className="shrink-0 border-b border-outline-variant/30 bg-surface-container-low/70 p-5 space-y-5">
        ...
        <label className="block">
          <span className="sr-only">Select site project</span>
      ...
      <div className="min-h-0 flex-1 overflow-y-auto p-4 pb-24 custom-scrollbar">
        {!selectedSite ? (
          <EmptyState label="No site projects" />
        ) : filteredGroups.length === 0 ? (
          <EmptyState label="No pages found" />
        ) : (
          <div className="space-y-3">
            ...
            >
              ...
              <span className="truncate text-xs font-black uppercase tracking-tight">Project Overview</span>
            </Link>
