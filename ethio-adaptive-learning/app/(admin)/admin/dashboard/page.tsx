...
export default async function AdminDashboardPage() {
  ...
  const actionCards = isAdmin
    ? [
        ...
        {
          title: "CMS concepts",
          description: "Create and maintain course concepts, prerequisites, and learning structure.",
    ...
    : [
        {
          ...
          description: "Build new curriculum content and author concepts for the Grade 12 flow.",
          href: "/admin/cms/concepts",
          icon: FileText,
          badge: "Author",
        },
