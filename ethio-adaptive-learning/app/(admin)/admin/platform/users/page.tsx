  ...
  return (
    <div className="max-w-6xl mx-auto space-y-10 animate-in fade-in duration-500">
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6">
        <div>
          <h1 className="text-3xl font-display font-black text-on-surface uppercase tracking-tight leading-tight">User Accounts</h1>
          <p className="text-on-surface-variant opacity-60 mt-1.5 font-medium">Manage and audit all platform identities and global access.</p>
        </div>

        <div className="relative group">
          <Search className="absolute left-4 top-1/2 -translate-y-1/2 size-4 text-on-surface-variant opacity-40 group-focus-within:text-primary transition-all" />
          <input 
            type="text" 
            placeholder="Filter by username or email..."
            className="pl-11 pr-4 py-3 rounded-2xl border border-outline-variant bg-white text-sm font-bold text-on-surface focus:border-primary focus:ring-4 focus:ring-primary/5 outline-none transition-all w-full sm:w-80 shadow-sm"
          />
        </div>
      </div>
