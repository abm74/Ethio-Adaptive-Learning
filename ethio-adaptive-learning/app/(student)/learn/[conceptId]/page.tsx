            ...
            <article className="rounded-[2rem] border border-border bg-white p-8 shadow-sm">
              ...
              <div className="mt-6 space-y-6">
                <ContentBlocksRenderer
                  assets={workspace.concept.contentBlockAssets}
                  blocks={workspace.concept.contentBlocks}
                  questions={workspace.concept.contentBlockQuestions}
                  snippets={workspace.concept.contentBlockSnippets}
                />
              </div>
            </article>
